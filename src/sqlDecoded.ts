...
export type SQLDecoded<TData = unknown, TDriver = unknown> = SQL<TData> & DriverValueDecoder<TData, TDriver>;
...
export function sqlDecoded<TData extends Primitive>(sql: SQL<TData>): SQLDecoded<TData, TData>;
...
export const hasDecoder = <T>(value: T): value is T & DriverValueDecoder<unknown, unknown> => {
    return (
        value !== null &&
        typeof value === "object" &&
